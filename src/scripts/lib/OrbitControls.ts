...
import { EventDispatcher, Matrix4, MOUSE, OrthographicCamera, PerspectiveCamera, Quaternion, Spherical, TOUCH, Vector2, Vector3 } from "three";
...
export class OrbitControls extends EventDispatcher {
    public readonly object: PerspectiveCamera | OrthographicCamera;
    ...
    /** The four arrow keys */
    public readonly keys = { LEFT: 37, UP: 38, RIGHT: 39, BOTTOM: 40 };

    /** Mouse buttons */
    public readonly mouseButtons = { LEFT: MOUSE.ROTATE, MIDDLE: MOUSE.DOLLY, RIGHT: MOUSE.PAN };

    /** Touch fingers */
    public readonly touches = { ONE: TOUCH.ROTATE, TWO: TOUCH.DOLLY_PAN };
    ...
    private handleTouchEnd(_: TouchEvent) {
        // no-op
    }
